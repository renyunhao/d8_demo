...
namespace GameFramework
{
    ...
    public class RoundedImage : Image
    {
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            uv.x = sprite.rect.x / sprite.texture.width;
            uv.y = sprite.rect.y / sprite.texture.height;
            uv.z = (sprite.rect.x + sprite.rect.width) / sprite.texture.width;
            uv.w = (sprite.rect.y + sprite.rect.height) / sprite.texture.height;
            ...
            //计算出uv中对应的半径值坐标轴的半径
            float uvRadiusX = radius / (v.z - v.x) * sprite.rect.width / sprite.texture.width;
            float uvRadiusY = radius / (v.w - v.y) * sprite.rect.height / sprite.texture.height;
