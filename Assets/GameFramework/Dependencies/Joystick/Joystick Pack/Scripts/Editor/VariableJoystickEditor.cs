...
public class VariableJoystickEditor : JoystickEditor
{
    ...
    private SerializedProperty backgroundFollowCoeff;
    ...
    protected override void OnEnable()
    {
        ...
        backgroundFollowCoeff = serializedObject.FindProperty("backgroundFollowCoeff");
    ...
    protected override void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(backgroundFollowCoeff, new GUIContent("backgroundFollowCoeff", "."));
