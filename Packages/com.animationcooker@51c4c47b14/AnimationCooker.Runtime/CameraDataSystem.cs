// This system has one simple function - every frame it copies data from the camera gameobject
// into a singleton entity that can be used by other systems to fetch the current camera position in jobs.
...
{
    // holds data about the current camera position
